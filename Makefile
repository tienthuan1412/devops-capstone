...
NEW_IMAGE_NAME=zzhanamjchjzz/hello-app
CONTAINER_PORT=80
HOST_PORT=8080
KUBECTL=./bin/kubectl
...
install:	# TODO: Add a Docker analysis (DevSecOps)
	...
	sh ./bin/install_shellcheck.sh
	echo
	echo "Installing: hadolint"
	sh ./bin/install_hadolint.sh
	echo
	echo "Installing: kubectl"
	sh ./bin/install_kubectl.sh
	echo
	echo "Installing: eksctl"
	sh ./bin/install_eksctl.sh
